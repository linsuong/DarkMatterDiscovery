...
double ld345_min=-10 ,  ld345_max=10;
       ...
       while(a<n_points){ /* remember to close the loop in the end! */
 	MD1 = rnd_slg(MD1_min,MD1_max); DMP = rnd_slg(DMP_min,DMP_max);DM2 = rnd_slg(DM2_min,DM2_max);
