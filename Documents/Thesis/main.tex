...
The primary objective of this paper is to discover and analyse the parameters, namely $m_{h_1}$, $m_{h_2}$, $h_{h_\pm}$, $\lambda_2$, and $\lambda_{345}$, for the i2HDM model. In Section \ref{sec:i2HDM}, we provide a detailed introduction to the i2HDM model and the constraints that will be taken into consideration. Section \ref{sec:results} presents the results obtained along with the analysis. Finally, the conclusion is presented in Section \ref{sec:conclusion}.
...
\begin{itemize}
    ...
    \item At 80-90 GeV, we can observe 
    \item At 105 GeV
\end{itemize}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\caption{Plots with $m_{h_\pm}$ against other parameters.}
\end{figure}
