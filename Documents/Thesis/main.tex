...
In this study, we explore the parameter space of the i2HDM, focusing on the masses of the scalar particles ($m_{h_1}$, $m_{h_2}$, $m_{h_\pm}$) along with their mass differences, and the quartic couplings ($\lambda_2$, and $\lambda_{345}$) We incorporate the latest theoretical and experimental constraints, to find a valid parameter space for future experiments. We conclude to have found allowed DM mass regions $ 60.5 \gevs \leq \mhone \leq 75.5 \gev$ with values of $\mhtwo \geq 130 \gev$. Next there is another region where $\mhone, \text{ } \mhtwo \geq 450 \gev$.\todo{wite in results}
