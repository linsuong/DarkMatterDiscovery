...
As mentioned earlier, i2HDM is an extension of SM that introduces new scalar particles that could be candidates for DM. The field, along with its Hermitian conjugate is:
\begin{align}
    &\Phi_2 = \frac{1}{\sqrt{2}}
        \begin{pmatrix}
            {\sqrt{2}h^+} \\
...
The 5-D datasets are projected onto a 2-D plane. Due to size constraints, the remaining plots cannot be shown here. They will be shown in the final project. 
...
For the remainder of the project, while adding more theory to the earlier part of the study, the cross sections of DM annihilation processes will be investigated. We dive deeper into DM production by calculating the cross section of DM production at the collider level of area $10^1 \rightarrow 10^2\text{ pb}^2$. All possible production channels of DM will be investigated. We will be looking at additional decay channels of DM in detail, as well as cases where virtual particles are involved.
\newpage
